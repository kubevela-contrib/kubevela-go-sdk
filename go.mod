...
require (
	github.com/oam-dev/kubevela-core-api v1.7.8-0.20260116042113-3461775e5e3f
...
// for sub-module
// require github.com/kubevela-contrib/kubevela-go-sdk v0.0.0-20230309022604-cd431bb25a9a
