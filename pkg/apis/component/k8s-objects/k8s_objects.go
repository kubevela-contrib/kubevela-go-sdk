...
func (k *K8sObjectsComponent) Inputs(input v1alpha1.StepInputs) *K8sObjectsComponent {
	k.Base.Inputs = input
	return k
}

func (k *K8sObjectsComponent) Outputs(output v1alpha1.StepOutputs) *K8sObjectsComponent {
