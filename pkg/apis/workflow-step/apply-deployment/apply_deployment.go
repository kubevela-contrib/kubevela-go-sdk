...
func (a *ApplyDeploymentWorkflowStep) Build() v1alpha1.WorkflowStep {
...
func (a *ApplyDeploymentWorkflowStep) FromWorkflowStep(from v1alpha1.WorkflowStep) (*ApplyDeploymentWorkflowStep, error) {
...
func (a *ApplyDeploymentWorkflowStep) FromWorkflowSubStep(from v1alpha1.WorkflowStepBase) (*ApplyDeploymentWorkflowStep, error) {
	var properties ApplyDeploymentSpec
	if from.Properties != nil {
		err := json.Unmarshal(from.Properties.Raw, &properties)
		if err != nil {
...
func (a *ApplyDeploymentWorkflowStep) Inputs(input v1alpha1.StepInputs) *ApplyDeploymentWorkflowStep {
	a.Base.Inputs = input
	return a
}

func (a *ApplyDeploymentWorkflowStep) Outputs(output v1alpha1.StepOutputs) *ApplyDeploymentWorkflowStep {
