...
func (d *DeployWorkflowStep) Build() v1alpha1.WorkflowStep {
...
func (d *DeployWorkflowStep) FromWorkflowStep(from v1alpha1.WorkflowStep) (*DeployWorkflowStep, error) {
...
func (d *DeployWorkflowStep) FromWorkflowSubStep(from v1alpha1.WorkflowStepBase) (*DeployWorkflowStep, error) {
	var properties DeploySpec
	if from.Properties != nil {
		err := json.Unmarshal(from.Properties.Raw, &properties)
		if err != nil {
...
func (d *DeployWorkflowStep) Inputs(input v1alpha1.StepInputs) *DeployWorkflowStep {
	d.Base.Inputs = input
	return d
}

func (d *DeployWorkflowStep) Outputs(output v1alpha1.StepOutputs) *DeployWorkflowStep {
