...
func (a *ApplyComponentWorkflowStep) Build() v1alpha1.WorkflowStep {
...
func (a *ApplyComponentWorkflowStep) FromWorkflowStep(from v1alpha1.WorkflowStep) (*ApplyComponentWorkflowStep, error) {
...
func (a *ApplyComponentWorkflowStep) FromWorkflowSubStep(from v1alpha1.WorkflowStepBase) (*ApplyComponentWorkflowStep, error) {
	var properties ApplyComponentSpec
	if from.Properties != nil {
		err := json.Unmarshal(from.Properties.Raw, &properties)
		if err != nil {
...
func (a *ApplyComponentWorkflowStep) Inputs(input v1alpha1.StepInputs) *ApplyComponentWorkflowStep {
	a.Base.Inputs = input
	return a
}

func (a *ApplyComponentWorkflowStep) Outputs(output v1alpha1.StepOutputs) *ApplyComponentWorkflowStep {
