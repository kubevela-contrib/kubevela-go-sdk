...
func (e *ExportDataWorkflowStep) Build() v1alpha1.WorkflowStep {
...
func (e *ExportDataWorkflowStep) FromWorkflowStep(from v1alpha1.WorkflowStep) (*ExportDataWorkflowStep, error) {
...
func (e *ExportDataWorkflowStep) FromWorkflowSubStep(from v1alpha1.WorkflowStepBase) (*ExportDataWorkflowStep, error) {
	var properties ExportDataSpec
	if from.Properties != nil {
		err := json.Unmarshal(from.Properties.Raw, &properties)
		if err != nil {
...
func (e *ExportDataWorkflowStep) Inputs(input v1alpha1.StepInputs) *ExportDataWorkflowStep {
	e.Base.Inputs = input
	return e
}

func (e *ExportDataWorkflowStep) Outputs(output v1alpha1.StepOutputs) *ExportDataWorkflowStep {
